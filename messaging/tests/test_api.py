...
def test_message_serializer_create_updates_thread_timestamp(
    ...
    request = factory.post("/api/threads/%s/messages/" % thread.id, {"content": "Hello"})
...
@pytest.mark.django_db
def test_thread_serializer_includes_last_message(owner_user, agent_user, organisations_setup):
...
@pytest.mark.django_db
def test_thread_list_returns_user_threads(api_client, owner_user, agent_user, organisations_setup):
...
@pytest.mark.django_db
def test_thread_messages_endpoints(api_client, owner_user, agent_user, organisations_setup):
